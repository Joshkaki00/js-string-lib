 ...
 */
export function containsSubstring(str, substr, caseSensitive = true) {
 ...
 */
export function randomString(length, options = {}) {
 ...
 * @param {boolean} [options.showFirst=true] - Show first N characters (false for last N)
 ...
 */
export function maskString(str, visibleChars, options = {}) {
  if (typeof str !== 'string') return '';
